...
> [!IMPORTANT]
> **This Action only works on Windows runners**, which should not be a problem as you' wi'll not be compiling and bundling MSIX files on non-windows platforms anyways.
...
```yaml
  - name: Make msixbundle
    id: bundler
    uses: LanceMcCarthy/actions/msix-bundler@v0
      ...
